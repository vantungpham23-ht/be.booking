...
/** Mặc định: mọi lịch từ hôm nay (SK) trở đi để note / gọi khách. */
type DateViewMode = "upcoming" | "day";
...
export function AdminBookings() {
  ...
  >("all");
  const [dateViewMode, setDateViewMode] = useState<DateViewMode>("upcoming");
